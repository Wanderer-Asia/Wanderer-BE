...
func (_m *Repository) GetAll(ctx context.Context, flt filters.Filter) ([]locations.Location, error) {
...
func (_m *Repository) GetDetail(ctx context.Context, id uint) (*locations.Location, error) {
	ret := _m.Called(ctx, id)
